 ...
 * 2. 利用 checkpoint 成功了才生成文件，不然二进制文件容易被截断而不可用。如果 checkpoint 失败，文件将不被写入。
 *
 */
public class Streaming2ColumnFormatFileWithCompress {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 可以分隔文件保存
        StreamingFileSink<ParquetPojo> parquetSink = StreamingFileSink.forBulkFormat(new Path("file:///e:/tmp/flink/out/columnformat"), ParquetAvroWritersWithCompress.forReflectRecord(ParquetPojo.class, CompressionCodecName.SNAPPY))
