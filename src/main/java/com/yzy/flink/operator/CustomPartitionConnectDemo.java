 ...
 *
 */
public class CustomPartitionConnectDemo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<MyKafkaRecord> kafkaRecordDataStream = kafkaInputSource.partitionCustom(new CustomPartitioner(), new KeySelector<MyKafkaRecord, MyKafkaRecord>() {
            @Override
        ...
        DataStream<Tuple2<MyKafkaRecord, String>> hdfsTuple2DataStream = countryDictSource.map(new MapFunction<String, Tuple2<MyKafkaRecord, String>>() {
            ...
            public Tuple2<MyKafkaRecord, String> map(String value) throws Exception {
                ...
                return Tuple2.of(new MyKafkaRecord(split[0]), split[1]);
            }
        }).partitionCustom(new CustomPartitioner(), new KeySelector<Tuple2<MyKafkaRecord, String>, MyKafkaRecord>() {
            @Override
